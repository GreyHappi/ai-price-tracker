...
|---|---|---|---|---|
| | PT-002 Phase 0 foundation — spec triplet accepted 2026-08-24 after review + regeneration (`review.md` §9); T01–T33 ready to implement, open items in §10 | | | PT-001 Phase −1 risk spike (review reconciliation accepted) |
